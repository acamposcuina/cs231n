...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # Hidden Affine Layer
        W2 = np.random.normal(0.0, weight_scale, (num_filters * H * W // 4, hidden_dim)) # //4 por el max pooling
    ...
    def loss(self, X, y=None):
        ...
        # Forward: conv - relu - 2x2 max pool - affine - relu - affine - softmax
